...
These entries stay in scope for release cleanup so maintainers can explicitly
close or convert them to backlog issues with recorded rationale.
...
| [#128](https://github.com/TrueAlpha-spiral/TrueAlpha-spiral/pull/128) | Jules 10832388898367026940 75d2a052 *(non-descriptive title; owner summary required before merge)* | needs fixes | 2026-04-22 | 20 | @jules | Release 2026.05 RC1 | `area:general, risk:medium, priority:P2, release-candidate:yes` |
