...
| [#128](https://github.com/TrueAlpha-spiral/TrueAlpha-spiral/pull/128) | Owner summary required before merge (current PR title is non-descriptive) | needs fixes | 2026-04-22 | 20 | @jules | Release 2026.05 RC1 | `area:general, risk:medium, priority:P2, release-candidate:yes` |
